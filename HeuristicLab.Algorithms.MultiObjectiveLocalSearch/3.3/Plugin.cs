...
namespace HeuristicLab.Algorithms.MultiObjectiveLocalSearch {
  [Plugin("HeuristicLab.Algorithms.MultiObjectiveLocalSearch", "3.3.16.0")]
  [PluginFile("HeuristicLab.Algorithms.MultiObjectiveLocalSearch-3.3.dll", PluginFileType.Assembly)]
  ...
  public sealed class HeuristicLabAlgorithmsMultiObjectiveLocalSearchPlugin : PluginBase {
  }
}
