...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.Alba {
  ...
  public class AlbaEncodedSolution : General.PermutationEncoding {
    ...
    public AlbaEncodedSolution(Permutation permutation, IVRPProblemInstance instance)
      : base(permutation, instance) {
    }

    [StorableConstructor]
    protected AlbaEncodedSolution(StorableConstructorFlag _) : base(_) {
    }

    public override IDeepCloneable Clone(Cloner cloner) {
      return new AlbaEncodedSolution(this, cloner);
    }

    protected AlbaEncodedSolution(AlbaEncodedSolution original, Cloner cloner)
      : base(original, cloner) {
    }

    public static AlbaEncodedSolution ConvertFrom(List<int> routeParam, IVRPProblemInstance instance) {
      ...
      return new AlbaEncodedSolution(
