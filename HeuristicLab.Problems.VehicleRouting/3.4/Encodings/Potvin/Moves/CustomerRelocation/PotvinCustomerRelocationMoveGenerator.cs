...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.Potvin {
  ...
  public abstract class PotvinCustomerRelocationMoveGenerator : PotvinMoveGenerator, IPotvinCustomerRelocationMoveOperator {
    ...
    protected abstract PotvinCustomerRelocationMove[] GenerateMoves(PotvinEncodedSolution individual, IVRPProblemInstance problemInstance);

    public override IOperation InstrumentedApply() {
      IOperation next = base.InstrumentedApply();

      PotvinEncodedSolution individual = VRPToursParameter.ActualValue as PotvinEncodedSolution;
