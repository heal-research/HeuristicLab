...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.Alba {
  ...
  [StorableClass]
  public abstract class AlbaIntraRouteInversionMoveGenerator : AlbaMoveOperator, IExhaustiveMoveGenerator, IAlbaIntraRouteInversionMoveOperator {
    ...
    protected AlbaIntraRouteInversionMoveGenerator(AlbaIntraRouteInversionMoveGenerator original, Cloner cloner) : base(original, cloner) { }
    ...
    protected abstract AlbaIntraRouteInversionMove[] GenerateMoves(AlbaEncoding individual);

    public override IOperation Apply() {
      IOperation next = base.Apply();

      AlbaEncoding individual = VRPToursParameter.ActualValue as AlbaEncoding;
      AlbaIntraRouteInversionMove[] moves = GenerateMoves(individual);
