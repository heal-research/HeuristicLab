...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic.Regression {
  [Plugin("HeuristicLab.Problems.DataAnalysis.Symbolic.Regression","Provides classes to perform symbolic regression (single- or multi-objective).", "3.4.13.0")]
  ...
  [PluginDependency("HeuristicLab.Problems.DataAnalysis.Symbolic.NativeInterpreter", "0.2")]
