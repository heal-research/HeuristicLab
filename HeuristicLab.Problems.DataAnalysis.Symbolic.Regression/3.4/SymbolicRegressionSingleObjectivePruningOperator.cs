...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic.Regression {
  ...
  [Item("SymbolicRegressionSingleObjectivePruningOperator", "An operator which prunes symbolic regression trees.")]
  public class SymbolicRegressionSingleObjectivePruningOperator : SymbolicDataAnalysisSingleObjectiveExpressionPruningOperator {
    ...
    protected SymbolicRegressionSingleObjectivePruningOperator(SymbolicRegressionSingleObjectivePruningOperator original, Cloner cloner)
      : base(original, cloner) {
    }
    public override IDeepCloneable Clone(Cloner cloner) {
      return new SymbolicRegressionSingleObjectivePruningOperator(this, cloner);
    }

    [StorableConstructor]
    protected SymbolicRegressionSingleObjectivePruningOperator(StorableConstructorFlag _) : base(_) { }

    public SymbolicRegressionSingleObjectivePruningOperator(ISymbolicDataAnalysisSolutionImpactValuesCalculator impactValuesCalculator)
