...
namespace HeuristicLab.Problems.PTSP.Views {
  ...
  public partial class CoordinatesPTSPDataView : CoordinatesTSPDataView {
    ...
    public CoordinatesPTSPDataView() {
      InitializeComponent();
      SuspendLayout();
      Controls.Remove(coordinatesMatrixView);
      coordinatesMatrixView.Dock = System.Windows.Forms.DockStyle.None;
      coordinatesTabPage.Controls.Add(coordinatesMatrixView);
      coordinatesMatrixView.Dock = System.Windows.Forms.DockStyle.Fill;
      ResumeLayout(true);
    }
