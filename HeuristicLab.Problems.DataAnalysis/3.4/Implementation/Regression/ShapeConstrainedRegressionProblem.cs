...
namespace HeuristicLab.Problems.DataAnalysis {
  ...
  public class ShapeConstrainedRegressionProblem : DataAnalysisProblem<IShapeConstrainedRegressionProblemData>, IShapeConstrainedRegressionProblem {
    [StorableConstructor]
    ...
    public override void Load(IShapeConstrainedRegressionProblemData data) {
