...
namespace HeuristicLab.Algorithms.DataAnalysis {
  ...
  [Obsolete("This version uses alglib version 3.7. Use NearestNeighbourModel instead.")]
  public sealed class NearestNeighbourModelAlglib_3_7 : ClassificationModel, INearestNeighbourModel {

    private readonly object kdTreeLockObject = new object();

    private alglib_3_7.alglib.nearestneighbor.kdtree kdTree;
    public alglib_3_7.alglib.nearestneighbor.kdtree KDTree {
      get { return kdTree; }
      set {
        if (value != kdTree) {
    ...
    [StorableConstructor]
    private NearestNeighbourModelAlglib_3_7(StorableConstructorFlag _) : base(_) {
      kdTree = new alglib_3_7.alglib.nearestneighbor.kdtree();
    }
    private NearestNeighbourModelAlglib_3_7(NearestNeighbourModelAlglib_3_7 original, Cloner cloner)
    ...
    public NearestNeighbourModelAlglib_3_7(IDataset dataset, IEnumerable<int> rows, int k, bool selfMatch, string targetVariable, IEnumerable<string> allowedInputVariables, IEnumerable<double> weights = null, double[] classValues = null)
      : base(targetVariable) {
      Name = ItemName;
      ...
      this.kdTree = new alglib_3_7.alglib.nearestneighbor.kdtree();
      ...
      alglib_3_7.alglib.nearestneighbor.kdtreebuild(inputMatrix, nRows, inputMatrix.GetLength(1) - 1, 1, 2, kdTree);
    }
    ...
    public override IDeepCloneable Clone(Cloner cloner) {
      return new NearestNeighbourModelAlglib_3_7(this, cloner);
    }
    ...
    public IEnumerable<double> GetEstimatedValues(IDataset dataset, IEnumerable<int> rows) {
      ...
      for (int row = 0; row < n; row++) {
        ...
        lock (kdTreeLockObject) { // gkronber: the following calls change the kdTree data structure
          numNeighbours = alglib_3_7.alglib.nearestneighbor.kdtreequeryknn(kdTree, x, k, selfMatch);
          alglib_3_7.alglib.nearestneighbor.kdtreequeryresultsdistances(kdTree, ref dists);
          alglib_3_7.alglib.nearestneighbor.kdtreequeryresultsxy(kdTree, ref neighbours);
        }
        if (selfMatch) {
