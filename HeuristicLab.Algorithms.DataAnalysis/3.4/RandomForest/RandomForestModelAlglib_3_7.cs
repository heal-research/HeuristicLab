...
namespace HeuristicLab.Algorithms.DataAnalysis {
  ...
  [Item("RandomForestModel (alglib 3.7)", "Represents a random forest for regression and classification.")]
  [Obsolete("This version uses alglib version 3.7. Use RandomForestModelFull instead.")]
  public sealed class RandomForestModelAlglib_3_7 : ClassificationModel, IRandomForestModel {
    ...
    [StorableConstructor]
    private RandomForestModelAlglib_3_7(StorableConstructorFlag _) : base(_) {
      randomForest = new alglib_3_7.alglib.decisionforest();
    }

    private RandomForestModelAlglib_3_7(RandomForestModelAlglib_3_7 original, Cloner cloner) : base(original, cloner) {
      randomForest = new alglib_3_7.alglib.decisionforest();
    ...
    public override IDeepCloneable Clone(Cloner cloner) {
      return new RandomForestModelAlglib_3_7(this, cloner);
    }

    public RandomForestModelAlglib_3_7(alglib_3_7.alglib.decisionforest decisionForest, string targetVariable, IEnumerable<string> inputVariables, IEnumerable<double> classValues = null) : base(targetVariable) {
      this.name = ItemName;
