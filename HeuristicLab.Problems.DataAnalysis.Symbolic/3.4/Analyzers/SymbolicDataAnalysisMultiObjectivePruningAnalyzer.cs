...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic {
  [StorableType("A9B713F6-87E6-4C48-8BF6-04A98A8A1F02")]
  ...
  public abstract class SymbolicDataAnalysisMultiObjectivePruningAnalyzer : SymbolicDataAnalysisMultiObjectiveAnalyzer {
    ...
    #region properties
    protected abstract SymbolicDataAnalysisMultiObjectiveExpressionPruningOperator PruningOperator { get; }
    ...
    [StorableConstructor]
    protected SymbolicDataAnalysisMultiObjectivePruningAnalyzer(StorableConstructorFlag _) : base(_) { }

    protected SymbolicDataAnalysisMultiObjectivePruningAnalyzer(SymbolicDataAnalysisMultiObjectivePruningAnalyzer original, Cloner cloner)
    ...
    protected SymbolicDataAnalysisMultiObjectivePruningAnalyzer() {
    ...
    private IntRange GetSliceBounds() {
      if (PopulationSliceStart < 0 || PopulationSliceEnd < 0) throw new ArgumentOutOfRangeException(nameof(PopulationSliceStart)+" "+ nameof(PopulationSliceEnd), "The slice bounds cannot be negative.");
      if (PopulationSliceStart > 1 || PopulationSliceEnd > 1) throw new ArgumentOutOfRangeException(nameof(PopulationSliceStart)+" "+ nameof(PopulationSliceEnd), "The slice bounds should be expressed as unit percentages.");
      ...
      if (start >= end) throw new ArgumentOutOfRangeException(nameof(PopulationSliceStart)+" "+ nameof(PopulationSliceEnd), "Invalid PopulationSlice bounds.");
