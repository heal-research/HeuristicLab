...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic {
  ...
  public abstract class SymbolicDataAnalysisSingleObjectiveExpressionPruningOperator : SingleSuccessorOperator, ISymbolicExpressionTreeOperator {
    ...
    public ILookupParameter<DoubleValue> QualityParameter => (ILookupParameter<DoubleValue>)Parameters[QualityParameterName];
    ...
    [StorableConstructor]
    protected SymbolicDataAnalysisSingleObjectiveExpressionPruningOperator(StorableConstructorFlag _) : base(_) { }
    protected SymbolicDataAnalysisSingleObjectiveExpressionPruningOperator(SymbolicDataAnalysisSingleObjectiveExpressionPruningOperator original, Cloner cloner)
      : base(original, cloner) { }

    protected SymbolicDataAnalysisSingleObjectiveExpressionPruningOperator(ISymbolicDataAnalysisSolutionImpactValuesCalculator impactValuesCalculator) {
    ...
    public override IOperation Apply() {
      ...
      if (prunedSubtrees > 0 || simplify) // if nothing was pruned then there's no need to re-evaluate the tree
