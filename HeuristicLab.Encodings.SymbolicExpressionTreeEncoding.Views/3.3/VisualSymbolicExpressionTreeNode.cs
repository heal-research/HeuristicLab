...
namespace HeuristicLab.Encodings.SymbolicExpressionTreeEncoding.Views {
  public class VisualSymbolicExpressionTreeNode {
    ...
    public VisualSymbolicExpressionTreeNode(SymbolicExpressionTreeNode symbolicExpressionTreeNode) :
      this(symbolicExpressionTreeNode, defaultLineColor) {
    }

    public VisualSymbolicExpressionTreeNode(SymbolicExpressionTreeNode symbolicExpressionTreeNode, Color lineColor) :
      this(symbolicExpressionTreeNode, lineColor, defaultTextColor) {
    }

    public VisualSymbolicExpressionTreeNode(SymbolicExpressionTreeNode symbolicExpressionTreeNode, Color lineColor, Color textColor) :
      this(symbolicExpressionTreeNode, lineColor, textColor, defaultFillColor) {
    }

    public VisualSymbolicExpressionTreeNode(SymbolicExpressionTreeNode symbolicExpressionTreeNode, Color lineColor, Color textColor, Color fillColor) :
      this(symbolicExpressionTreeNode, lineColor, textColor, fillColor, defaultPreferredWidth, defaultPreferredHeight) {
    }

    public VisualSymbolicExpressionTreeNode(SymbolicExpressionTreeNode symbolicExpressionTreeNode, Color lineColor, Color textColor, Color fillColor, int width, int height) {
    ...
    private SymbolicExpressionTreeNode symbolicExpressionTreeNode;
    public SymbolicExpressionTreeNode SymbolicExpressionTreeNode {
