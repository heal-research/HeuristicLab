...
namespace HeuristicLab.Optimization.Algorithms {
  [Item("AlgorithmContext", "")]
  [StorableClass]
  public abstract class AlgorithmContext : ParameterizedNamedItem, IExecutionContext {
    ...
    [StorableConstructor]
    protected AlgorithmContext(bool deserializing) : base(deserializing) { }
    protected AlgorithmContext(AlgorithmContext original, Cloner cloner)
      : base(original, cloner) { }
    protected AlgorithmContext() : this(new Scope("Scope")) { }
    protected AlgorithmContext(IScope s) {
      scope = s;
    }
