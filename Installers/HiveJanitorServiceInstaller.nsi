...
Section "HeuristicLabHiveJanitorService (required)"
	...
	File "${JANITORBUILDPATH}\Google.Protobuf.dll"
	File "${JANITORBUILDPATH}\HEAL.Attic.dll"
...
Section "un.Uninstall"  
	...
	Delete "$INSTDIR\HeuristicLab.Services.Access.DataAccess.dll"
