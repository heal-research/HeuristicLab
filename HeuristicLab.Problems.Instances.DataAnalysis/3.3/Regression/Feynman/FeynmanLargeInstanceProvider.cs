...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class FeynmanLargeInstanceProvider : ArtificialRegressionInstanceProvider {
    public override string Name {
      get { return "'AI Feynman' Benchmark Problems (large)"; }
    }
    ...
    public FeynmanLargeInstanceProvider() : this((int)DateTime.Now.Ticks) { }

    public FeynmanLargeInstanceProvider(int seed) {
      Seed = seed;
    }
