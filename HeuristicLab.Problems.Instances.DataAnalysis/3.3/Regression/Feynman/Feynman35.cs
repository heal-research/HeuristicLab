...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class Feynman35 : FeynmanDescriptor {
    private readonly int testSamples;
    private readonly int trainingSamples;

    public Feynman35() : this((int) DateTime.Now.Ticks, 10000, 10000, null) { }

    public Feynman35(int seed) {
      Seed            = seed;
    ...
    public Feynman35(int seed, int trainingSamples, int testSamples, double? noiseRatio) {
      Seed                 = seed;
    ...
    public override string Name {
      get {
        return string.Format("I.34.10 omega_0/(1-v/c) | {0} samples | {1}", trainingSamples,
