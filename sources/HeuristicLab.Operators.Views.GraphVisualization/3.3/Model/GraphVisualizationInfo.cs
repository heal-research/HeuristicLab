...
namespace HeuristicLab.Operators.Views.GraphVisualization {
  public sealed class GraphVisualizationInfo : DeepCloneable {
    ...
    public IShapeInfo InitialShape {
      ...
      set {
        if (value == null)
          ...
          this.OperatorGraph.InitialOperator = this.shapeInfoMapping.GetBySecond(value);
      }
    }
    ...
    public IOperator GetOperatorForShapeInfo(IShapeInfo shapeInfo) {
      return this.shapeInfoMapping.GetBySecond(shapeInfo);
    }
