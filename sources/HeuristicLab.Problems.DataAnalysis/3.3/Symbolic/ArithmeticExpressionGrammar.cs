...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic {
  ...
  public class ArithmeticExpressionGrammar : Item, ISymbolicExpressionGrammar {
    ...
    private static List<Symbol> allSymbols = new List<Symbol>() {
      ...
      new Division(),
      new Constant(),
      new HeuristicLab.Problems.DataAnalysis.Symbolic.Symbols.Variable()
    };
    [Storable]
    ...
    private Dictionary<Type, int> minLength = new Dictionary<Type, int>() {
      ...
      {typeof(Division), 4},
      {typeof(Constant), 1},
      {typeof(HeuristicLab.Problems.DataAnalysis.Symbolic.Symbols.Variable), 1},
    };
    ...
    private Dictionary<Type, int> minDepth = new Dictionary<Type, int>() {
      ...
      {typeof(Division), 1},
      {typeof(Constant), 0},
      {typeof(HeuristicLab.Problems.DataAnalysis.Symbolic.Symbols.Variable), 0}
    };
