...
if "%Platform%" == "x86" (   
  copy /B /Y "%SolutionDir%\HeuristicLab.SQLite\System.Data.SQLite.dll" .\plugins
) else if "%Platform%" == "x64" ( 
  copy /B /Y "%SolutionDir%\HeuristicLab.SQLite\System.Data.SQLite.x64.dll" .\plugins\System.Data.SQLite.dll
