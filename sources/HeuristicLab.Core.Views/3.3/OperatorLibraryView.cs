...
namespace HeuristicLab.Core.Views {
  ...
  /// </summary>
  [Content(typeof(OperatorLibrary), true)]
  public partial class OperatorLibraryView : ItemViewBase {
    ...
    public OperatorLibraryView(IOperatorLibrary operatorLibrary)
      : this() {
    ...
    private void contextMenuStrip_Opening(object sender, CancelEventArgs e) {
      ...
      if (operatorsTreeView.SelectedNode != null) {
        IOperator op = operatorsTreeView.SelectedNode.Tag as IOperator;
        if (op != null) {
          IItemView view = (IItemView)MainFormManager.CreateDefaultView(op);
          if (view != null) {
    ...
    private void viewToolStripMenuItem_Click(object sender, EventArgs e) {
      IView view = viewToolStripMenuItem.Tag as IView;
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    #endregion
