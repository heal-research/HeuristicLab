...
namespace alglib
{
    public class cinverse
    {
        ...
        *************************************************************************/
        ...
        public static bool complexinverselu(ref AP.Complex[,] a,
            ref int[] pivots,
            int n)
        {
            bool result = new bool();
            ...
            // Form inv(U)
            //
            if( !ctrinverse.complexinvtriangular(ref a, n, true, false) )
            {
                result = false;
                return result;
            }
        ...
        public static bool complexinverse(ref AP.Complex[,] a,
            int n)
        {
            bool result = new bool();
            int[] pivots = new int[0];
            ...
            result = complexinverselu(ref a, ref pivots, n);
            return result;
        }
    }
}
