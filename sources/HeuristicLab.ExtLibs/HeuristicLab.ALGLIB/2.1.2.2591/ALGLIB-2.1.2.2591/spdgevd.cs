    ...
    public class spdgevd
    {
        ...
        *************************************************************************/
            ...
            ref double[,] z)
        {
            ...
            result = sevd.smatrixevd(a, n, zneeded, isuppera, ref d, ref t);
            if( !result )
            {
                return result;
            }
        ...
        *************************************************************************/
            ...
            ref bool isupperr)
        {
            ...
            if( problemtype==1 )
            {
                ...
                if( !cholesky.spdmatrixcholesky(ref t, n, false) )
                {
                    result = false;
                    return result;
                }
                ...
                // Invert L in T
                //
                if( !trinverse.rmatrixtrinverse(ref t, n, false, false) )
                {
                    result = false;
                    return result;
                }
            ...
            if( problemtype==2 | problemtype==3 )
            {
                ...
                if( !cholesky.spdmatrixcholesky(ref t, n, true) )
                {
                    result = false;
                    return result;
                }
                ...
                if( problemtype==2 )
                {
                    ...
                    // Invert U in T
                    //
                    if( !trinverse.rmatrixtrinverse(ref t, n, true, false) )
                    {
                        result = false;
                        return result;
                    }
        ...
        public static bool generalizedsymmetricdefiniteevd(double[,] a,
            int n,
            bool isuppera,
            ref double[,] b,
            bool isupperb,
            ...
            ref double[,] z)
        {
            ...
            // Reduce and solve
            //
            result = generalizedsymmetricdefiniteevdreduce(ref a, n, isuppera, ref b, isupperb, problemtype, ref r, ref isupperr);
            if( !result )
            {
                return result;
            }
            result = sevd.symmetricevd(a, n, zneeded, isuppera, ref d, ref t);
            if( !result )
            {
                return result;
            }
        ...
        public static bool generalizedsymmetricdefiniteevdreduce(ref double[,] a,
            int n,
            bool isuppera,
            ref double[,] b,
            bool isupperb,
            ...
            ref bool isupperr)
        {
            ...
            System.Diagnostics.Debug.Assert(n>0, "GeneralizedSymmetricDefiniteEVDReduce: N<=0!");
            System.Diagnostics.Debug.Assert(problemtype==1 | problemtype==2 | problemtype==3, "GeneralizedSymmetricDefiniteEVDReduce: incorrect ProblemType!");
            result = true;
            ...
            if( problemtype==1 )
            {
                ...
                if( !cholesky.choleskydecomposition(ref t, n, false) )
                {
                    result = false;
                    return result;
                }
                ...
                // Invert L in T
                //
                if( !trinverse.invtriangular(ref t, n, false, false) )
                {
                    result = false;
                    return result;
                }
                ...
                for(j=1; j<=n; j++)
                {
                    ...
                    sblas.symmetricmatrixvectormultiply(ref a, isuppera, 1, j, ref w1, 1.0, ref w2);
                    if( isuppera )
                    {
                        blas.matrixvectormultiply(ref a, 1, j, j+1, n, true, ref w1, 1, j, 1.0, ref w2, j+1, n, 0.0);
                    }
                    else
                    {
                        blas.matrixvectormultiply(ref a, j+1, n, 1, j, false, ref w1, 1, j, 1.0, ref w2, j+1, n, 0.0);
                    }
            ...
            if( problemtype==2 | problemtype==3 )
            {
                ...
                if( !cholesky.choleskydecomposition(ref t, n, true) )
                {
                    result = false;
                    return result;
                }
                ...
                for(j=1; j<=n; j++)
                {
                    ...
                    sblas.symmetricmatrixvectormultiply(ref a, isuppera, j, n, ref w1, 1.0, ref w3);
                    i1_ = (1) - (j);
                    for(i_=j; i_<=n;i_++)
                    {
                        w2[i_] = w3[i_+i1_];
                    ...
                    if( isuppera )
                    {
                        blas.matrixvectormultiply(ref a, 1, j-1, j, n, false, ref w1, j, n, 1.0, ref w2, 1, j-1, 0.0);
                    }
                    else
                    {
                        blas.matrixvectormultiply(ref a, j, n, 1, j-1, true, ref w1, j, n, 1.0, ref w2, 1, j-1, 0.0);
                    }
                ...
                if( problemtype==2 )
                {
                    ...
                    // Invert U in T
                    //
                    if( !trinverse.invtriangular(ref t, n, true, false) )
                    {
                        result = false;
                        return result;
                    }
