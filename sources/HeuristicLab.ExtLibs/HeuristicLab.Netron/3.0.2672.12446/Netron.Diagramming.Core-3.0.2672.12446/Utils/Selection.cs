...
namespace Netron.Diagramming.Core
{
    ...
    public static class Selection
    {
        ...
        /// </summary>
        // ------------------------------------------------------------------
        private static CollectionBase<IDiagramEntity> mSelection = 
        ...
        public static Bitmap ToBitmap()
        {
            ...
            Graphics g = Controller.View.Graphics;
            g.Transform = Controller.View.ViewMatrix;
        ...
        public static void CollectEntitiesAt(
            Point surfacePoint, 
        ...
        static void SelectEntity(IDiagramEntity entity, Point surfacePoint)
        {
