...
namespace HeuristicLab.SGA {
  ...
  public partial class SGAView : ItemViewBase {
    ...
    private void viewProblemInitializationButton_Click(object sender, EventArgs e) {
      IView view = MainFormManager.CreateDefaultView(SGA.ProblemInjector);
    ...
    private void viewSolutionGenerationButton_Click(object sender, EventArgs e) {
      IView view = MainFormManager.CreateDefaultView(SGA.SolutionGenerator);
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    private void viewSelectionButton_Click(object sender, EventArgs e) {
      IView view = MainFormManager.CreateDefaultView(SGA.Selector);
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    private void viewCrossoverButton_Click(object sender, EventArgs e) {
      IView view = MainFormManager.CreateDefaultView(SGA.Crossover);
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    private void viewMutationButton_Click(object sender, EventArgs e) {
      IView view = MainFormManager.CreateDefaultView(SGA.Mutator);
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    private void viewEvaluationButton_Click(object sender, EventArgs e) {
      IView view = MainFormManager.CreateDefaultView(SGA.Evaluator);
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    ...
    private void cloneEngineButton_Click(object sender, EventArgs e) {
      ...
      IView view = MainFormManager.CreateDefaultView(clone);
      if (view != null) MainFormManager.MainForm.ShowView(view);
    }
    #endregion
