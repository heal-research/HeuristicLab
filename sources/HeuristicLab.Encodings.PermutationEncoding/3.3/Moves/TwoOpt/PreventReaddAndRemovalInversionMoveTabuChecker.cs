...
namespace HeuristicLab.Encodings.PermutationEncoding {
  [Item("PreventReaddAndRemovalInversionMoveTabuChecker", "Prevents readding of previously deleted edges as well as deleting previously added edges.")]
  [StorableClass]
  public class PreventReaddAndRemovalInversionMoveTabuChecker : SingleSuccessorOperator, IPermutationInversionMoveOperator, ITabuChecker {
    ...
    public PreventReaddAndRemovalInversionMoveTabuChecker()
      : base() {
          ...
          case PermutationTypes.RelativeUndirected: {
            ...
            if (relAttrib != null) {
              ...
              if (relAttrib.Edge1Source == E1S && relAttrib.Edge1Target == E2S || relAttrib.Edge1Source == E2S && relAttrib.Edge1Target == E1S
                ...
                || relAttrib.Edge1Source == E1S && relAttrib.Edge2Source == E1T || relAttrib.Edge1Source == E1T && relAttrib.Edge2Source == E1S
          ...
          case PermutationTypes.RelativeDirected: {
            ...
            if (relAttrib != null) {
              if (relAttrib.Edge1Source == E1S && relAttrib.Edge1Target == E2S
                ...
                // if previously added Edge1Source-Edge2Source is deleted
                || relAttrib.Edge1Source == E1S && relAttrib.Edge2Source == E1T
