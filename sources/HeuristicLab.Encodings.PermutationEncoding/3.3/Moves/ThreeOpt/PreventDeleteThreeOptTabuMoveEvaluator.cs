...
namespace HeuristicLab.Encodings.PermutationEncoding {
  [Item("ThreeOptPreventEdgeRemoval", "Prevents deleting of previously added edges.")]
  [StorableClass]
  public class PreventDeleteThreeOptTabuMoveEvaluator : SingleSuccessorOperator, IThreeOptPermutationMoveOperator, ITabuMoveEvaluator {
    ...
    public PreventDeleteThreeOptTabuMoveEvaluator()
      : base() {
