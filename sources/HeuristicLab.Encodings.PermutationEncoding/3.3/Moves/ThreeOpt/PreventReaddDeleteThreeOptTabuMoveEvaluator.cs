...
namespace HeuristicLab.Encodings.PermutationEncoding {
  [Item("ThreeOptPreventEdgeRemovalAndReadding", "Prevents readding of previously deleted edges as well as deleting previously added edges.")]
  [StorableClass]
  public class PreventReaddDeleteThreeOptTabuMoveEvaluator : SingleSuccessorOperator, IThreeOptPermutationMoveOperator, ITabuMoveEvaluator {
    ...
    public PreventReaddDeleteThreeOptTabuMoveEvaluator()
      : base() {
