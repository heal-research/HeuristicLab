...
namespace HeuristicLab.Encodings.PermutationEncoding {
  [Item("PreventRemovalTranslocationMoveTabuChecker", "Prevents deleting of previously added edges.")]
  [StorableClass]
  public class PreventRemovalTranslocationMoveTabuChecker : SingleSuccessorOperator, IPermutationTranslocationMoveOperator, ITabuChecker {
    ...
    public PreventRemovalTranslocationMoveTabuChecker()
      : base() {
      ...
      if (!isTabu) {
        foreach (IItem tabuMove in tabuList) {
          ...
          if (attribute != null) {
            ...
            if (attribute.Edge3Source == E1S && attribute.Edge1Target == E1T || attribute.Edge3Source == E1T && attribute.Edge1Target == E1S
