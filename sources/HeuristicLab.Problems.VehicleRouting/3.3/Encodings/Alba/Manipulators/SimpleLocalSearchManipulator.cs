...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.Alba {
  [Item("SimpleLocalSearchManipulator", "An operator which applies the SLS operation to an Alba VRP representation.  It is implemented as described in Alba, E. and Dorronsoro, B. (2004). Solving the Vehicle Routing Problem by Using Cellular Genetic Algorithms.")]
  [StorableClass]
  public sealed class SimpleLocalSearchManipulator : AlbaManipulator {   
    [StorableConstructor]
    private SimpleLocalSearchManipulator(bool deserializing) : base(deserializing) { }

    public SimpleLocalSearchManipulator()
      : base() {
     }
