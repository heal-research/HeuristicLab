...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.Alba {
  [Item("IntraRouteInversionManipulator", "An operator which applies the SLS operation to a VRP representation. It is implemented as described in Alba, E. and Dorronsoro, B. (2004). Solving the Vehicle Routing Problem by Using Cellular Genetic Algorithms.")]
  [StorableClass]
  public sealed class IntraRouteInversionManipulator : AlbaManipulator {   
    [StorableConstructor]
    private IntraRouteInversionManipulator(bool deserializing) : base(deserializing) { }

    public IntraRouteInversionManipulator()
      : base() {
     }
