...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.Alba {
  ...
  [StorableClass]
  public sealed class AlbaPushForwardCreator : VRPCreator, IStochasticOperator {
    ...
    public override IOperation Apply() {
      VRPSolutionParameter.ActualValue = new AlbaEncoding(CreateSolution(), CitiesParameter.ActualValue.Value);
    ...
    private Permutation CreateSolution() {
      ...
      int vehicle = CitiesParameter.ActualValue.Value;
      ...
      return new Permutation(PermutationTypes.RelativeDirected, route.ToArray());
    }
  }
}
