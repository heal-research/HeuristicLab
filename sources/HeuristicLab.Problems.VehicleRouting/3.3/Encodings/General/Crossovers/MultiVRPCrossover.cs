...
namespace HeuristicLab.Problems.VehicleRouting.Encodings.General {
  [Item("MultiVRPCrossover", "Randomly selects and applies one of its crossovers every time it is called.")]
  [StorableClass]
  public class MultiVRPCrossover : StochasticMultiBranch<IVRPCrossover>, IVRPCrossover, IStochasticOperator {
    ...
    [StorableConstructor]
    private MultiVRPCrossover(bool deserializing) : base(deserializing) { }
    public MultiVRPCrossover()
      : base() {
      ...
      foreach (Type type in ApplicationManager.Manager.GetTypes(typeof(IVRPCrossover))) {
