...
namespace HeuristicLab.Problems.ArtificialAnt.Views {
  ...
  public sealed partial class AntTrailView : ItemView {
      ...
      if ((pictureBox.Width > 0) && (pictureBox.Height > 0)) {
        if (Content != null) {
          ...
          using (Graphics graphics = Graphics.FromImage(pictureBox.Image)) {
            ...
            AntInterpreter interpreter = new AntInterpreter(Content.SymbolicExpressionTree, Content.World, Content.MaxTimeSteps);
    ...
    private void playButton_Click(object sender, EventArgs e) {
      ...
      animationInterpreter = new AntInterpreter(Content.SymbolicExpressionTree, Content.World, Content.MaxTimeSteps);
