...
namespace HeuristicLab.GP {
  ...
  public class LangdonHomologousCrossOver : OperatorBase {
    ...
    private IFunctionTree GetReplacementBranch(IRandom random, TreeGardener gardener, IList<IFunction> allowedFunctions, IFunctionTree tree, List<int> removedBranchThread, int removedBranchSize, int maxBranchSize, int maxBranchHeight) {
