...
namespace HeuristicLab.GP.StructureIdentification {
  public class HL3TreeEvaluatorInjector : OperatorBase {
    public HL3TreeEvaluatorInjector()
      : base() {
    ...
    public override string Description {
      get { return "Injects a tree evaluator."; }
    }
    ...
    public override IOperation Apply(IScope scope) {
      ...
      HL3TreeEvaluator evaluator = new HL3TreeEvaluator(minEstimatedValue, maxEstimatedValue);
