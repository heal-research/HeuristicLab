...
namespace HeuristicLab.GP.StructureIdentification {
  [ClassInfo(Name = "HeuristicLab.GP.StructureIdentification-3.4")]
  [PluginFile(Filename = "HeuristicLab.GP.StructureIdentification-3.4.dll", Filetype = PluginFileType.Assembly)]
  ...
  [Dependency(Dependency = "HeuristicLab.DataAnalysis-3.3")]
  [Dependency(Dependency = "HeuristicLab.Evolutionary-3.3")]
  [Dependency(Dependency = "HeuristicLab.GP-3.4")]
  ...
  [Dependency(Dependency = "HeuristicLab.Operators.Programmable-3.3")]
  [Dependency(Dependency = "HeuristicLab.Random-3.3")]
  [Dependency(Dependency = "HeuristicLab.Selection-3.3")]
  [Dependency(Dependency = "HeuristicLab.Selection.OffspringSelection-3.3")]
