...
namespace HeuristicLab.Problems.Instances.Regression {
  public class BreimanOne : ArtificialRegressionDataDescriptor {
    ...
    protected override List<List<double>> GenerateValues() {
      ...
      data.Add(BreimanOne.GenerateUniformIntegerDistribution(values, TestPartitionEnd));
      values.Add(0);
    ...
    public static List<double> GenerateUniformIntegerDistribution(List<int> classes, int amount) {
