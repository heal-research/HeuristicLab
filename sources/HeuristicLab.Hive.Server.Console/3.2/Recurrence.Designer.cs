namespace HeuristicLab.Hive.Client.Console
{
  partial class Recurrence
  {
    ...
    private void InitializeComponent()
    {
      ...
      // txtDays
      // 
      this.txtDays.Location = new System.Drawing.Point(160, 13);
      ...
      // gbWeekly
      // 
      this.gbWeekly.Controls.Add(this.label7);
      this.gbWeekly.Controls.Add(this.cbSunday);
      this.gbWeekly.Controls.Add(this.txtDays);
