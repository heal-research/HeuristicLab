...
namespace HeuristicLab.GP.StructureIdentification.Classification {
  public abstract class GPClassificationEvaluatorBase : GPEvaluatorBase {
    ...
    public abstract void Evaluate(IScope scope, BakedTreeEvaluator evaluator, Dataset dataset, int targetVariable, double[] classes, double[] thresholds, int start, int end);
  }
}
