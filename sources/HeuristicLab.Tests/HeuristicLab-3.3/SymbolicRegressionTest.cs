...
namespace HeuristicLab_33.Tests {
  ...
  public class SymbolicRegressionTest {
    ...
    public void SymbolicRegressionPerformanceTest() {
      ...
      double expectedValidationQuality = 0.76055761244321707;
      double expectedBestQuality = 0.728252514650427;
      double expectedAverageQuality = 0.44404977994074729;
      ...
      TestContext.WriteLine("Best validation solution quality: {0} (should be {1})", bestValidationSolutionQuality, expectedValidationQuality);
