  ...
  public class GPSymbolicRegressionSampleWithOSTest {
    ...
    public void RunGPSymbolicRegressionSampleWithOSTest() {
      ...
      if (Environment.Is64BitProcess) {
        Assert.AreEqual(0.99174959007940156, SamplesUtils.GetDoubleResult(osga, "BestQuality"), 1E-8, Environment.NewLine + "Best Qualitiy differs.");
    ...
    private OffspringSelectionGeneticAlgorithm CreateGpSymbolicRegressionSample() {
      ...
      osga.Description = "Genetic programming with strict offsrping selection solving a benchmark regression problem.";
