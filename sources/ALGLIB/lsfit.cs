    ...
    public class lsfit
    {
        ...
        *************************************************************************/
        ...
        public struct lsfitstate
        {
            ...
            public minlm.lmstate optstate;
            public minlm.lmreport optrep;
        ...
        *************************************************************************/
            ...
            ref lsfitreport rep)
        {
            ...
            else
            {
                ...
                //
                lq.rmatrixlq(ref cmatrix, k, m, ref tau);
                lq.rmatrixlqunpackq(ref cmatrix, k, m, ref tau, m, ref q);
                for(i=0; i<=k-1; i++)
                {
                    for(j=i+1; j<=m-1; j++)
                    {
        ...
        *************************************************************************/
        public static bool lsfitnonlineariteration(ref lsfitstate state)
        {
            ...
            if( state.havehess )
            {
                ...
                //
                minlm.minlmfgh(k, ref state.c, AP.Math.Sqr(state.epsf)*n, state.epsx, state.maxits, ref state.optstate);
            }
            else
            {
                ...
                if( state.cheapfg )
                {
                    minlm.minlmfgj(k, n, ref state.c, AP.Math.Sqr(state.epsf)*n, state.epsx, state.maxits, ref state.optstate);
                }
                else
                {
                    minlm.minlmfj(k, n, ref state.c, AP.Math.Sqr(state.epsf)*n, state.epsx, state.maxits, ref state.optstate);
                }
            }
        ...
        *************************************************************************/
            ...
            ref lsfitreport rep)
        {
            ...
            if( n<m )
            {
                ...
                rep.taskrcond = 0;
                lq.rmatrixlq(ref ft, n, m, ref tau);
                lq.rmatrixlqunpackq(ref ft, n, m, ref tau, n, ref q);
                lq.rmatrixlqunpackl(ref ft, n, m, ref l);
            ...
            qr.rmatrixqr(ref ft, n, m, ref tau);
            qr.rmatrixqrunpackq(ref ft, n, m, ref tau, m, ref q);
            qr.rmatrixqrunpackr(ref ft, n, m, ref r);
            tmp = new double[m];
            for(i=0; i<=m-1; i++)
            {
                tmp[i] = 0;
