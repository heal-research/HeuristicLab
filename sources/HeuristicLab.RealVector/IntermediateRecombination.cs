...
namespace HeuristicLab.RealVector {
  public class IntermediateRecombination : OperatorBase {
    public override string Description {
      get {
        return @"Intermediate recombination creates a new offspring by computing the centroid of a number of parents";
      }
    }

    public IntermediateRecombination()
      : base() {
    ...
    public override IOperation Apply(IScope scope) {
      ...
      for (int i = 0; i < lambda; i++) {
        ...
        // actual intermediate recombination
