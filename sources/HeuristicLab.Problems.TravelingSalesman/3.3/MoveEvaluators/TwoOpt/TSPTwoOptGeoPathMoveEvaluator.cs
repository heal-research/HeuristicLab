...
namespace HeuristicLab.Problems.TravelingSalesman {
  ...
  /// </summary>
  [Item("TSPTwoOptGeoPathMoveEvaluator", "Operator for evaluating a 2-opt move based on geo (world) distances.")]
  [StorableClass]
  public class TSPTwoOptGeoPathMoveEvaluator : TSPTwoOptPathMoveEvaluator {
