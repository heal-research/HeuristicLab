...
namespace HeuristicLab.Problems.TravelingSalesman {
  ...
  /// </summary>
  [Item("TSPThreeOptEuclideanPathMoveEvaluator", "Operator for evaluating a 3-opt move based on euclidean distances.")]
  [StorableClass]
  public class TSPThreeOptEuclideanPathMoveEvaluator : TSPThreeOptPathMoveEvaluator {
