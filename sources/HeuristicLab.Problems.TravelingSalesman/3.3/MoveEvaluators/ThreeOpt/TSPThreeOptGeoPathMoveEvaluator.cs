...
namespace HeuristicLab.Problems.TravelingSalesman {
  ...
  /// </summary>
  [Item("TSPThreeOptGeoPathMoveEvaluator", "Operator for evaluating a 3-opt move based on geo (world) distances.")]
  [StorableClass]
  public class TSPThreeOptGeoPathMoveEvaluator : TSPThreeOptPathMoveEvaluator {
