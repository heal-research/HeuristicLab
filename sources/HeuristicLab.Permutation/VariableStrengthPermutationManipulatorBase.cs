...
namespace HeuristicLab.Permutation {
  public abstract class VariableStrengthPermutationManipulatorBase : PermutationManipulatorBase {

    public VariableStrengthPermutationManipulatorBase()
      : base() {
    ...
    public override IOperation Apply(IScope scope) {
      ...
      int strength = (int)Math.Ceiling(shakingFactor);
