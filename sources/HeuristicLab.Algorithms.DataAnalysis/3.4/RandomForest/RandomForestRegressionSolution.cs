...
namespace HeuristicLab.Algorithms.DataAnalysis {
  ...
  public sealed class RandomForestRegressionSolution : RegressionSolution, IRandomForestRegressionSolution {
    ...
    public new IRandomForestRegressionModel Model {
      get { return (IRandomForestRegressionModel)base.Model; }
    ...
    public RandomForestRegressionSolution(IRegressionProblemData problemData, IRandomForestRegressionModel randomForestModel)
