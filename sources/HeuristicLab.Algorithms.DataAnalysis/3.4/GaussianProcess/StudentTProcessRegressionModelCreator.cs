...
namespace HeuristicLab.Algorithms.DataAnalysis {
  [StorableClass]
  [Item(Name = "StudentTProcessRegressionModelCreator",
    Description = "Creates a Student-t process model for regression given the data, the hyperparameters, a mean function, and a covariance function.")]
  public sealed class StudentTProcessRegressionModelCreator : GaussianProcessModelCreator, IGaussianProcessRegressionModelCreator {
    ...
    #endregion
    [StorableConstructor]
    private StudentTProcessRegressionModelCreator(bool deserializing) : base(deserializing) { }
    private StudentTProcessRegressionModelCreator(StudentTProcessRegressionModelCreator original, Cloner cloner) : base(original, cloner) { }
    public StudentTProcessRegressionModelCreator()
      : base() {
    ...
    public override IDeepCloneable Clone(Cloner cloner) {
      return new StudentTProcessRegressionModelCreator(this, cloner);
    }
    ...
    public static IGaussianProcessModel Create(IRegressionProblemData problemData, double[] hyperparameter, IMeanFunction meanFunction, ICovarianceFunction covarianceFunction, bool scaleInputs = true) {
      return new StudentTProcessModel(problemData.Dataset, problemData.TargetVariable, problemData.AllowedInputVariables, problemData.TrainingIndices, hyperparameter, meanFunction, covarianceFunction, scaleInputs);
    }
  }
}
