...
namespace HeuristicLab.Problems.DataAnalysis.Views {
  partial class TimeSeriesPrognosisSolutionScatterPlotView {
    /// <summary> 
    ...
    private void InitializeComponent() {
      ...
      // 
      // TimeSeriesPrognosisSolutionScatterPlotView
      // 
      this.AllowDrop = true;
      this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
      this.Controls.Add(this.chart);
      this.Name = "TimeSeriesPrognosisSolutionScatterPlotView";
