...
namespace HeuristicLab.Operators.Programmable {
  [ClassInfo(Name = "HeuristicLab.Operators.Programmable-3.2")]
  [PluginFile(Filename = "HeuristicLab.Operators.Programmable-3.2.dll", Filetype = PluginFileType.Assembly)]
