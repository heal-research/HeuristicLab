...
namespace HeuristicLab.GP.SantaFe {
  [Plugin("HeuristicLab.GP.SantaFe-3.3")]
  [PluginFile("HeuristicLab.GP.SantaFe-3.3.dll", PluginFileType.Assembly)]
  ...
  public class HeuristicLabGPSantaFePlugin : PluginBase {
  }
}
