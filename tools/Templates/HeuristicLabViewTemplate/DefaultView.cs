...
namespace $rootnamespace$ {
  [View("$safeitemname$")]
  [Content(typeof($viewContentType$), IsDefaultView = $isDefaultView$)]
  public partial class $safeitemname$ : $baseClass$ {
    public new $viewContentType$ Content {
      get { return ($viewContentType$)base.Content; }
